  ...
  if (error) {
    return (
      <div className="text-center p-8 bg-red-900/20 border border-red-500 rounded-lg max-w-2xl mx-auto">
        ...
        <p className="text-sm text-gray-400 mt-2">Please try reloading the page or using a different video file. If this persists, please check the console for more details.</p>
      </div>
    );
  }
